...
console.log(`\n[predeploy] All ${checks.length} checks passed.${withDatabase?' Database migration 007 is available.':' Run npm run test:predeploy:db after applying the database migrations.'}`)
