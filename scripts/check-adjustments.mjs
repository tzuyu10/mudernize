...
if(profiles.error||resets.error||tallies.error||batches.error||users.error||registrations.error){
 console.error('Database adjustments are not installed. Run database/003_product_adjustments.sql through database/009_tally_balances.sql in order in Supabase SQL Editor.')
 process.exitCode=1
